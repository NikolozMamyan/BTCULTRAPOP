...
final class FrontNavigationTest extends WebTestCase
{
    ...
    public function testShopDisplaysImportedProducts(): void
    {
        ...
        self::assertSelectorExists('.shop-category-img-container--root img[src*="/assets/img/categories/all-products."]');
        self::assertSelectorExists('.shop-category-img-container img[src*="/assets/img/categories/boissons-naruto-tropical-"][src$=".png"]');
        self::assertSelectorExists('.shop-category-img-container img[src*="/assets/img/categories/epicerie-salee-komesan-luffy-"][src$=".png"]');
        self::assertSelectorExists('.shop-category-img-container img[src*="/assets/img/categories/epicerie-sucree-yokosan-cereales."]');
        self::assertSelectorExists('.shop-category-img-container img[src*="/assets/img/categories/coffrets-box-naruto."]');
    ...
    public function testProductPageDisplaysTheSelectedProduct(): void
    {
        ...
        self::assertSelectorExists('[data-panel="ingredients"] .product-ingredient-grid');
        self::assertSelectorTextContains('[data-panel="ingredients"] .product-ingredient-card:nth-child(1)', 'Eau');
        self::assertSelectorTextContains('[data-panel="ingredients"] .product-ingredient-card:nth-child(2)', 'sucre');
        self::assertSelectorExists('[data-panel="ingredients"] .product-ingredient-card__icon .fa-droplet');
        self::assertSelectorTextContains('[data-panel="ingredients"] .product-ingredient-information', 'consommer de préférence');
